...
define('G5_MYSQL_USER', 'nssite');
define('G5_MYSQL_PASSWORD', 'ska66799!');
define('G5_MYSQL_DB', 'nssite');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', 'bf5f1aa7593f18345431404230435fd6'); // 토큰 암호화에 사용할 키
