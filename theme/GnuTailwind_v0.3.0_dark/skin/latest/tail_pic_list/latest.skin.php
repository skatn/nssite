...
<div class="pic_li_lt relative mb-4">
    <h2 class="lat_title border-t border-b py-2 bg-gray-100"><a href="<?php echo get_pretty_url($bo_table); ?>" class="text-lg font-semibold px-2"><?php echo $bo_subject ?></a></h2>
    <ul class="mt-4">
    <?php
    ...
    <li class="empty_li py-6 border-b text-center">게시물이 없습니다.</li>
    <?php }  ?>
    </ul>
