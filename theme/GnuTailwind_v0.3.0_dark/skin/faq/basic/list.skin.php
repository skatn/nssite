...
<fieldset id="faq_sch">
  ...
  <form name="faq_search_form" method="get">
    ...
    <input type="text" name="stx" value="<?php echo $stx; ?>" required id="stx" class="frm_input px-3 bg-white" size="15" maxlength="15">
    <button type="submit" value="검색" class="align-middle leading-8 h-8 px-3 inline-block text-center font-normal border-0 text-base transition transition-colors duration-300 ease-out text-white bg-gray-500 hover:bg-gray-600 rounded mt-3 sm:mt-0 ml-0 sm:ml-2"><i class="fa fa-search" aria-hidden="true"></i> 검색</button>
  </form>
</fieldset>
