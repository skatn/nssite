...
<!-- 설문조사 결과 시작 { -->
<div id="poll_result" class="new_win container mx-auto">
    ...
    <div class="new_win_con2">
        ...
        <section id="poll_result_cmt">
        	...
        	<button type="submit" class="leading-8 h-8 px-3 text-center font-normal border-0 text-base transition transition-colors duration-300 ease-out text-white bg-indigo-500 hover:bg-indigo-600 rounded">의견남기기</button>
			</div>
            </form>
            <?php }  ?>
