...
<section id="poll">
    ...
    <div class="poll_con">
        ...
        <div id="poll_btn">
            <button type="submit" class="block w-full h-8 leading-8 px-3 border-0 font-semibold bg-indigo-500 hover:bg-indigo-600 text-white rounded-sm">투표하기</button>
<!--             display:block;width:100%;height:40px;line-height:40px;padding:0 10px;border:0;font-weight:bold;background:#3a8afd;color:#fff;border-radius:3px -->
        </div>
    </div>
</section>
</form>
