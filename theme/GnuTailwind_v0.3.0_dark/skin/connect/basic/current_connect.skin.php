...
<div id="current_connect">
    ...
    ?>
        <li>
<!--         float:left;line-height:45px;margin-right:20px;color:#777;font-weight:bold -->
            <span class="float-left leading-10 mr-6 text-indigo-500"><?php echo $list[$i]['num'] ?></span>
