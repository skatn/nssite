  ...
  <form name="fboardlist" id="fboardlist" action="<?php echo G5_BBS_URL; ?>/board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
    ...
    <?php if ($is_checkbox) { ?>
      <div class="clear-both flex items-center my-1">
        <div class="check_all bg-white border rounded border-gray-400 w-4 h-4 flex flex-shrink-0 justify-center items-center mr-2 focus-within:border-indigo-500">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" id="gall_ul">
        <?php for ($i = 0; $i < count($list); $i++) { ?>
          <div class="gall_box border relative rounded-lg shadow-lg">
            ...
            <a href="<?php echo $list[$i]['href'] ?>" class="c-card block bg-white overflow-hidden">
              <div class="relative pb-48 overflow-hidden text-center align-middle rounded-lg rounded-b-none">
                ...
                if ($thumb['src']) {
                  ...
                  $img_content = '<img class="absolute inset-0 h-full w-full object-cover rounded-b-none" src="' . $board_skin_url . '/img/no_img.png">';
                }
              ...
              <div class="mt-2">
                ...
                <p class="cont p-2 h-24 text-sm text-gray-500"><?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 68, '..'); ?></p>
                <div class="info-line p-2 border-t text-sm text-gray-500">
                  <div class="pt-1.5 flex justify-between">
                    <span class="pr-2 flex-start"><span class="sound_only">작성자 </span><?php echo $list[$i]['name'] ?></span>
                    <div>
                      <span class="pr-2"><span class="sound_only">작성일 </span><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo $list[$i]['datetime2'] ?></span>
                      <span class=""><span class="sound_only">조회 </span><i class="fa fa-eye" aria-hidden="true"></i> <?php echo $list[$i]['wr_hit'] ?></span>
                    </div>
                  </div>
                </div>
              </div>
