...
<div id="bo_gall" class="pt-4 pb-6">
  ...
  <form name="fboardlist" id="fboardlist" action="<?php echo G5_BBS_URL; ?>/board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
    ...
    <?php if ($is_checkbox) { ?>
      <div class="gall-chk clear-both flex items-center my-1">
    ...
    <div class="container mx-auto">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" id="gall_ul">
        ...
        ?>
          ...
          <div class="gall-box border rounded-lg shadow-lg relative mb-4">
            <div class="absolute top-2.5 left-2 z-10">
              <?php if ($is_checkbox) { ?>
                <div class="gall-chk flex items-center">
                  <div class="bg-white border rounded border-gray-400 w-4 h-4 flex flex-shrink-0 justify-center items-center mr-2 focus-within:border-indigo-500">
            ...
            <div>
              <a href="<?php echo $list[$i]['href'] ?>" class="c-card block bg-white overflow-hidden rounded-lg rounded-b-none">
                <div class="relative overflow-hidden text-center align-middle">
                  <?php
                  $thumb = get_list_thumbnail($board['bo_table'], $list[$i]['wr_id'], $board['bo_gallery_width'], $board['bo_gallery_height'], false, true);


                  if (!$list[$i]['wr_3'] || $list[$i]['wr_3'] == "noimg") {
                    if ($thumb['src']) {
                      $img_content = '<img class="absolute inset-0 h-full w-full object-cover rounded-b-none" src="' . $thumb['src'] . '" alt="' . $thumb['alt'] . '" >';
                    } else {
                      $img_content = '<img src="' . $board_skin_url . '/img/no_img.png">';
                    }
            ...
            <div class="p-2">
              <?php if ($is_category && $list[$i]['ca_name']) { ?>
                <a href="<?php echo $list[$i]['ca_name_href'] ?>" class="bg-indigo-100 text-indigo-500 font-normal py-0.5 px-1.5 rounded text-sm hover:underline mr-1"><?php echo $list[$i]['ca_name'] ?></a>
              <?php } ?>
              <a href="<?php echo $list[$i]['href'] ?>" class="bo_tit">
                ...
                <span class="font-semibold uppercase"><?php echo cut_str(get_text($list[$i]['wr_subject']), 12); ?></span>
                <?php
            ...
            <div class="info-line p-2 border-t text-sm text-gray-500 flex justify-between">
              <span class="pr-2 h-full">
              ...
              <?php if ($is_good) { ?>
                ...
                <strong class="pr-2"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> <?php echo $list[$i]['wr_good'] ?></strong>
              <?php } ?>
              <?php if ($is_nogood) { ?>
                <span class="sound_only">비추천</span>
                <strong><i class="fa fa-thumbs-o-down" aria-hidden="true"></i> <?php echo $list[$i]['wr_nogood'] ?></strong>
              <?php } ?>
            </div>
