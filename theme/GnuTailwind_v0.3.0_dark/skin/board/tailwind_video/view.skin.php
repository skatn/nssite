...
<article class="pt-4 pb-6">
  ...
  <section class="container mx-auto">
    ...
    <!-- 동영상 시작 { -->
    <?php
    // echo get_hostis($view['wr_link1']);

    $movie_company = $view['wr_1'];
    $movie_id = $view['wr_2'];
    if ($movie_company == "youtu") { ?>
      <div class="video-container relative pt-7 h-0 overflow-hidden">
        <iframe class="absolute top-0 left-0 w-full h-full" src="//www.youtube.com/embed/<?php echo $movie_id ?>?feature=player_detailpage&vq=hd720&rel=0" frameborder="0" allowfullscreen></iframe>
      </div>
    <?php } else if ($movie_company == "vimeo") { ?>
      <div class="video-container relative pt-7 h-0 overflow-hidden">
        <iframe class="absolute top-0 left-0 w-full h-full" src="https://player.vimeo.com/video/<?php echo $movie_id ?>?embedparameter=value" frameborder="0" allowfullscreen></iframe>
      </div>

    <?php } else if ($movie_company == "kakao") { ?>
      <div class="video-container relative pt-7 h-0 overflow-hidden">
        <iframe class="absolute top-0 left-0 w-full h-full" title="<?php echo $view['wr_subject'] ?>" src="https://play-tv.kakao.com/embed/player/cliplink/<?php echo $movie_id ?>?service=kakao_tv" allowfullscreen></iframe>
      </div>

    <?php } else if ($movie_company == "soundcloud") { ?>
      <div class="video-container-naver relative pt-7 h-0 overflow-hidden">
        <?php
    ...
    <?php } else if ($movie_company == "dailymotion") { ?>
      <div class="video-container relative pt-7 h-0 overflow-hidden">
        <iframe class="absolute top-0 left-0 w-full h-full" frameborder="0" src="https://www.dailymotion.com/embed/video/<?php echo $movie_id ?>" allowfullscreen></iframe>
      </div>
    <?php } else if ($movie_company == "naver") { ?>
      <div class="video-container relative pt-7 h-0 overflow-hidden">
        <iframe class="absolute top-0 left-0 w-full h-full" frameborder="0" src="https://tv.naver.com/embed/<?php echo $movie_id ?>" allowfullscreen></iframe>
      </div>
    <?php } ?>
    <!-- } 동영상 end -->
