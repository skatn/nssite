...
<section id="bo_v_ans_form">
    ...
    <div class="form_01">
        <ul>
            ...
            <li>
                ...
                <input type="text" name="qa_subject" value="" id="qa_subject" required class="frm_input required full_input p-2 border w-full my-2 outline-none" size="50" maxlength="255" placeholder="제목">
            </li>
    ...
    <div class="btn_confirm text-center mt-5">
        <button type="submit" id="btn_submit" accesskey="s" class="leading-8 h-8 px-3 text-center font-normal border-0 text-base transition transition-colors duration-300 ease-out text-white bg-indigo-500 hover:bg-indigo-600 rounded">답변등록</button>
    </div>
    </form>
    ...
    {
    ?>
    <p id="ans_msg" class="pt-4 text-center">고객님의 문의에 대한 답변을 준비 중입니다.</p>
    <?php
    }
    ?>
</section>